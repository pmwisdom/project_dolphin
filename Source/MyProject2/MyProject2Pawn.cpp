...
void AMyProject2Pawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Thrust", this, &AMyProject2Pawn::ThrustInput);
	PlayerInputComponent->BindAxis("MoveUp", this, &AMyProject2Pawn::MoveUpInput);
	PlayerInputComponent->BindAxis("MoveRight", this, &AMyProject2Pawn::MoveRightInput);
}

void AMyProject2Pawn::ThrustInput(float Val)
{
	// Is there any input?
...
void AMyProject2Pawn::MoveUpInput(float Val)
{
...
void AMyProject2Pawn::MoveRightInput(float Val)
{
